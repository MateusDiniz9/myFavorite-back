...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var animes, animesT, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.animes.findFirst()];
                case 1:
                    animes = _a.sent();
                    if (!!animes) return [3 /*break*/, 6];
                    return [4 /*yield*/, axios_1["default"]
                            .request(options)
                            .then(function (response) { return response.data.data; })["catch"](function (error) {
                            console.error(error);
                        })];
                case 2:
                    animesT = _a.sent();
                    ...
                    _a.label = 3;
                case 3:
                    if (!(i < animesT.length)) return [3 /*break*/, 6];
                    return [4 /*yield*/, prisma.animes.create({
                            data: {
